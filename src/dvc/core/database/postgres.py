...
class SQLFileExecutor:
    ...
    def _write_audit_table(self,
        ...
        with open(METADATA_SQL_FOLDER_PATH.joinpath("scm_public__insert_tbl_schema_version_history.sql"),
    ...
    def _create_audit_table(self):
        with open(METADATA_SQL_FOLDER_PATH.joinpath("scm_public__create_tbl_schema_version_history.sql"),
